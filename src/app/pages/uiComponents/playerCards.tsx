        ...
        <div className="fixed bottom-0 left-0 right-0 flex flex-col items-center p-4">
            ...
            <div 
              ...
              {currentPlayer.getCards().map((card, index) => (
                  ...
                  className={`rounded-2xl ${index === selectedCardIndex ? "shadow-lg shadow-blue-500/50" : ""} hover:shadow-lg hover:shadow-blue-500/50 ${chosenCardIndexes.includes(index) ? "border-4 border-yellow-500" : ""}`} />
                  </button>
              ))}
            </div>
        </div>
